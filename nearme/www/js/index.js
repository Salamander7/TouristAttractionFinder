...
function success_signin(userid){
  ...
  if (userid) {
      ...
      var $tab = $("<ons-tab page='settings.html'  id='tab4'  active></ons-tab> <ons-tab page='logout.html'  id='tab5'  ></ons-tab>");
      $('.tabbar').append($tab);
...
function logout(){
  ...
  var $tab = $("<ons-tab page='login.html'  id='tab3'  active></ons-tab>");
  $('.tabbar').append($tab);
